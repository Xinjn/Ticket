...
function SC5UI() {
    ...
    //加载Animation
    this.xhAni.loadAnimation("res/ani/xh_bg.ani"); //注意引入路径和后缀名称
    //设置位置
...
// 网络动态资源加载
Laya.URL.basePath = "https://xinjn.github.io/TicketRemote/"; //请把XXXX换成自己的真实网址；
...
function onBgBag() {
    //加载Animation
    xhAni.loadAnimation("res/ani/xh_bg.ani"); //注意引入路径和后缀名称
    //设置层级
    xhAni.zOrder = -1;
    //初始系数
    xhAni.scaleX = 1;
